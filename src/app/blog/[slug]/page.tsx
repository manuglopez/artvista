...
const PostPage = (props: any) => {
    ...
    return (
        <>
            <div className='max-w-2/3 flex flex-col items-center justify-center px-6 sm:px-14'>
                <h1 className='text-5xl  text-slate-500 font-light py-12'>{article.data.title}</h1>
                <Image className='rounded-md shadow-lg my-8 ' src={`/images/${slug}.jpg`} width={1024} height={768}
                       alt={article.data.subtitle}/>
