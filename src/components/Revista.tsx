    ...
    return (
        <div className='grid grid-cols-1 py-8  gap-3 sm:grid-cols-2 '>
            <motion.div
                ...
                className='flex px-16 content-center justify-center'>
                <Image className='sm:px-6'
                       priority={true}
                       width='501'
                       height='1008'
            ...
            <motion.div
                ...
                <h1 className='font-black text-7xl py-20'>NÚMERO ACTUAL</h1>
                <h2 className='font-extralight text-3xl pb-20'>Ilustraciones, humor y nuevas <br
                    ...
                    vida</h2>
                <Link  className='bg-black_arti text-yellow_arti py-3 px-8 mx-auto max-w-4xl rounded text-bold ' href="/revista">Leer aqui</Link>
